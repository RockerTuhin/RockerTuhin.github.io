...
<head>
    ...
    <!-- All CSS-->
    <link href="{{ asset('public/assets/css/compressed.css') }}" rel="stylesheet" media="all">

    <!--Favicons-->
    <link rel="shortcut icon" href="{{ asset('public/assets/favicon.html') }}">
    <link rel="apple-touch-icon" href="{{ asset('public/assets/apple-icon.html') }}">
    <link rel="apple-touch-icon" sizes="72x72" href="{{ asset('public/assets/apple-icon-72x72.html') }}">
    <link rel="apple-touch-icon" sizes="114x114" href="{{ asset('public/assets/apple-icon-114x114.html') }}">
</head>
...
<body class="animsition">
    ...
    <!-- Intro start-->
<section class="section section-intro js-intro" id="intro" data-intro-bg="{{ asset('public/assets/images/intro.jpg') }}" data-intro-layout="fullscreen">
        <div class="container">
            <article class="section-inner">
                <div class="row">
                    <div class="col-md-7">
                        ...
                        <img class="animated intro-sign" src="{{ URL::to('public/assets/images/icons/ic-sign.png') }}" alt="John Smith" data-intro-delay="2000" data-intro-animate="zoomIn">
                    </div>
                </div>
            </article>
        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <article class="card-secondary card-resume">
                                    <figure class="card-figure">
                                        <img class="resume-image img-fluid" src="{{ URL::to('public/assets/images/resume-ex-01.jpg') }}" alt="Project Manager" />
                            ...
                            <div class="col-lg-4">
                                <article class="card-secondary card-resume">
                                    <figure class="card-figure">
                                        <img class="resume-image img-fluid" src="{{ URL::to('public/assets/images/resume-ex-02.jpg') }}" alt="UI/UX Designer" />
                                        <a class="bg-overlay" href="#"></a>
                                    </figure>
                                    <header class="card-header">
                                        <h3 class="resume-title">
                            ...
                            <div class="col-lg-4">
                                <article class="card-secondary card-resume">
                                    <figure class="card-figure">
                                        <img class="resume-image img-fluid" src="{{ URL::to('public/assets/images/resume-ex-03.jpg') }}" alt="Web Development" />
                                        <a class="bg-overlay" href="#"></a>
                                    </figure>
                                    <header class="card-header">
                                        <h3 class="resume-title">
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6 wow zoomIn" data-wow-duration="0.5s" data-wow-delay="0.2s">
                        <article class="card-primary card-project">
                            ...
                            <figure class="card-figure">
                                <img class="project-image img-fluid" src="{{ URL::to('public/assets/images/project-01.jpg') }}" alt="Brand &amp; Strategy Contents" />
                            </figure>
                            <header class="card-header">
                    ...
                    <div class="col-lg-3 col-sm-6 wow zoomIn" data-wow-duration="0.5s" data-wow-delay="0.4s">
                        <article class="card-primary card-project">
                            <a class="card-link-overlay" href="#" data-toggle="modal" data-target="#project-post"></a>
                            <figure class="card-figure">
                                <img class="project-image img-fluid" src="{{ URL::to('public/assets/images/project-02.jpg') }}" alt="Brand &amp; Strategy Contents" />
                            </figure>
                            <header class="card-header">
                                <h3 class="project-title">Brand &amp; Strategy Contents</h3>
                                <ul class="project-subjects">
                    ...
                    <div class="col-lg-3 col-sm-6 wow zoomIn" data-wow-duration="0.5s" data-wow-delay="0.6s">
                        <article class="card-primary card-project">
                            <a class="card-link-overlay" href="#" data-toggle="modal" data-target="#project-post"></a>
                            <figure class="card-figure">
                                <img class="project-image img-fluid" src="{{ URL::to('public/assets/images/project-03.jpg') }}" alt="Brand &amp; Strategy Contents" />
                            </figure>
                            <header class="card-header">
                                <h3 class="project-title">Brand &amp; Strategy Contents</h3>
                                <ul class="project-subjects">
                    ...
                    <div class="col-lg-3 col-sm-6 wow zoomIn" data-wow-duration="0.5s" data-wow-delay="0.8s">
                        <article class="card-primary card-project">
                            <a class="card-link-overlay" href="#" data-toggle="modal" data-target="#project-post"></a>
                            <figure class="card-figure">
                                <img class="project-image img-fluid" src="{{ URL::to('public/assets/images/project-04.jpg') }}" alt="Brand &amp; Strategy Contents" />
                            </figure>
                            <header class="card-header">
                                <h3 class="project-title">Brand &amp; Strategy Contents</h3>
                                <ul class="project-subjects">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <article class="card-secondary card-blog">
                                    <figure class="card-figure">
                                        <img class="blog-image img-fluid" src="{{ URL::to('public/assets/images/blog-01.jpg') }}" alt="How to Create a Split-Screen Slider With JavaScript
" />
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <article class="card-secondary card-blog">
                                    <figure class="card-figure">
                                        <img class="blog-image img-fluid" src="{{ URL::to('public/assets/images/blog-02.jpg') }}" alt="New Short Course: Lightweight Carousels With John
" />
                                        <a class="bg-overlay" href="#" data-toggle="modal" data-target="#blog-post"></a>
                                    </figure>
                                    <header class="card-header">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <article class="card-secondary card-blog">
                                    <figure class="card-figure">
                                        <img class="blog-image img-fluid" src="{{ URL::to('public/assets/images/blog-03.jpg') }}" alt="10 Remedial Design Pointers for Developers
" />
                                        <a class="bg-overlay" href="#" data-toggle="modal" data-target="#blog-post"></a>
                                    </figure>
                                    <header class="card-header">
...
" />
                ...
                data-slick-nextarrow="&lt;i class='arrow arrow-next lnr lnr-chevron-right' data-toggle='tooltip' title='Next' &gt;&lt;/i&gt;" data-slick-loop="false">
                    <li class="box box-testimonials">
                        ...
                        <div class="client-avatar" data-animation="fadeIn" data-animation-delay="0.8s">
                            <img src="{{ URL::to('public/assets/images/avatar-03.jpg') }}" alt="Client">
                        </div>
                    ...
                    <li class="box box-testimonials">
                        ...
                        <div class="client-avatar" data-animation="fadeIn" data-animation-delay="0.8s">
                            <img src="{{ URL::to('public/assets/images/avatar-02.jpg') }}" alt="Client">
                        </div>
                        <div class="client-info">
                    ...
                    <li class="box box-testimonials">
                        ...
                        <div class="client-avatar" data-animation="fadeIn" data-animation-delay="0.8s">
                            <img src="{{ URL::to('public/assets/images/avatar-01.jpg') }}" alt="Client">
                        </div>
                        <div class="client-info">
                ...
                <ul class="list-reset js-slick partner-list" data-slick-lg="5" data-slick-md="3" data-slick-sm="2" data-slick-xs="1" data-slick-autoplay="true">
                    <li class="partner-item wow zoomIn" data-wow-duration="0.5s" data-wow-delay="0.2s">
                        <a class="box box-partner" href="#" data-toggle="tooltip" title="Wooecommerce">
                            <img class="partner-image" src="{{ URL::to('public/assets/images/icons/ic-partnership-01.png') }}" alt="partner">
                        </a>
                    </li>
                    <li class="partner-item wow zoomIn" data-wow-duration="0.5s" data-wow-delay="0.4s">
                        <a class="box box-partner" href="#" data-toggle="tooltip" title="WordPress">
                            <img class="partner-image" src="{{ URL::to('public/assets/images/icons/ic-partnership-02.png') }}" alt="partner">
                        </a>
                    </li>
                    <li class="partner-item wow zoomIn" data-wow-duration="0.5s" data-wow-delay="0.6s">
                        <a class="box box-partner" href="#" data-toggle="tooltip" title="Evanto">
                            <img class="partner-image" src="{{ URL::to('public/assets/images/icons/ic-partnership-03.png') }}" alt="partner">
                        </a>
                    </li>
                    <li class="partner-item wow zoomIn" data-wow-duration="0.5s" data-wow-delay="0.8s">
                        <a class="box box-partner" href="#" data-toggle="tooltip" title="Bootstrap">
                            <img class="partner-image" src="{{ URL::to('public/assets/images/icons/ic-partnership-04.png') }}" alt="partner">
                        </a>
                    </li>
                    <li class="partner-item wow zoomIn" data-wow-duration="0.5s" data-wow-delay="1s">
                        <a class="box box-partner" href="#" data-toggle="tooltip" title="Jquery">
                            <img class="partner-image" src="{{ URL::to('public/assets/images/icons/ic-partnership-05.png') }}" alt="partner">
                        </a>
                    </li>
                </ul>
            </div>
    ...
    <!-- section contact-->
    <section class="section section-contact bg-parallax p-t-110 p-b-80" id="contact" style="background: url(public/assets/images/bg-contact.jpg) center center no-repeat;">
                ...
                <div class="row section-contact-info">
                    ...
                    <div class="col-md col-sm-12">
                        <div class="box box-contact-info">
                            ...
                            <a class="box-text" href="mailto:rockertuhin96@gmail.com">rockertuhin96@gmail.com</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="section-inner">
                <ul class="h-list footer-social social-list">
                    <li class="list-item" data-toggle="tooltip" title="Email">
                        <a class="fa fa-envelope" href="mailto:rockertuhin96@gmail.com"></a>
                    </li>
                    <li class="list-item" data-toggle="tooltip" title="Twitter">
                        <a class="fa fa-twitter" href="#"></a>
                    </li>
                                ...
                                <div class="modal-body">
                                    <article class="post-blog m-b-55">
                                        ...
                                        <figure class="post-image">
                                            <img class="img-fluid" src="{{ URL::to('public/assets/images/blog-post-01.jpg') }}" alt="New Short Course: Lightweight Carousels With John">
                                        </figure>
                                        <div class="post-body">
                                        ...
                                        <footer class="post-footer">
                                            ...
                                            <div class="post-author">
                                                <div class="post-author-image">
                                                    <a href="#">
                                                        <img src="{{ URL::to('public/assets/images/avatar-04.jpg') }}" alt="John Doe">
                                                    </a>
                                                </div>
                                            ...
                                            <ul class="comment-pane-list">
                                                <li class="list-item has-comment-children">
                                                    <div class="comment-item">
                                                        <div class="comment-author-avatar">
                                                            <a href="#">
                                                                <img src="{{ URL::to('public/assets/images/avatar-05.jpg') }}" alt="Arthur Reyes">
                                                            </a>
                                                        </div>
                                                    ...
                                                    <ul class="comment-pane-list-children">
                                                        <li class="list-item">
                                                            <div class="comment-item">
                                                                <div class="comment-author-avatar">
                                                                    <a href="#">
                                                                        <img src="{{ URL::to('public/assets/images/avatar-06.jpg') }}" alt="Arthur Reyes">
                                                                    </a>
                                                                </div>
                                                                <div class="comment-text">
                                                ...
                                                <li class="list-item has-comment-children">
                                                    <div class="comment-item">
                                                        <div class="comment-author-avatar">
                                                            <a href="#">
                                                                <img src="{{ URL::to('public/assets/images/avatar-07.jpg') }}" alt="Arthur Reyes">
                                                            </a>
                                                        </div>
                                                        <div class="comment-text">
                                                            <p class="comment-paragraph">
                                                ...
                                                <figure class="post-image">
                                                    ...
                                                    data-slick-dotsclass="slick-dots-2">
                                                        <div class="project-image-item">
                                                            <img class="img-fluid" src="{{ URL::to('public/assets/images/project-post-01.jpg') }}" alt="Featured Details">
                                                        </div>
                                                        <div class="project-image-item">
                                                            <img class="img-fluid" src="{{ URL::to('public/assets/images/project-post-02.jpg') }}" alt="Featured Details">
                                                        </div>
                                                        <div class="project-image-item">
                                                            <img class="img-fluid" src="{{ URL::to('public/assets/images/project-post-03.jpg') }}" alt="Featured Details">
                                                        </div>
                                                    </div>
                                                </figure>
                                            </div>
    ...
    <!-- Vendor JS-->
    <script src="{{ asset('public/assets/vendor/validator/validator.min.js') }}"></script>
    <script src="{{ asset('public/assets/js/config-contact.js') }}"></script>

</body>

<script>'undefined'=== typeof _trfq || (window._trfq = []);'undefined'=== typeof _trfd && (window._trfd=[]),_trfd.push({'tccl.baseHost':'secureserver.net'}),_trfd.push({'ap':'cpsh'},{'server':'a2plcpnl0422'}) // Monitoring performance to make your website faster. If you want to opt-out, please contact web hosting support.</script><script src='{{ asset('public/assets/../../img1.wsimg.com/tcc/tcc_l.combined.1.0.6.min.js') }}'></script>
<!-- Mirrored from templates.aucreative.co/ora/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Dec 2018 04:19:06 GMT -->
</html>
<!-- end document-->